...
export default function LeaveScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Leave History</Text>
      <FlatList
        data={[]}
        renderItem={() => <Text style={styles.leaveItem}>[Leave item]</Text>}
        keyExtractor={(_, i) => i.toString()}
        ListEmptyComponent={<Text style={styles.leaveItem}>No leave history yet.</Text>}
      />
    </View>
  );
}
